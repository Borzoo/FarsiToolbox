...
namespace FarsiToolboxTests
{
    public class PersianDateTimeTests
    {
        ...
        [InlineData("94-12-29PM20:00", 1394, 12, 29, 20, 0, 0, 0)]
        ...
        [InlineData("1-1-1 12:00 pm", 1401, 1, 1, 12, 0, 0, 0, true)]
        [InlineData("01-1-1 12:00 pm", 1401, 1, 1, 12, 0, 0, 0, true)]
        [InlineData("1/2/31 12:00 pm", 1401, 2, 31, 12, 0, 0, 0, true)]
        [InlineData("01/2/31 12:00 pm", 1401, 2, 31, 12, 0, 0, 0, true)]
        [InlineData("49/2/31 12:00 pm", 1449, 2, 31, 12, 0, 0, 0, true)]
        [InlineData("50/2/31 12:00 pm", 1350, 2, 31, 12, 0, 0, 0, true)]
        [InlineData("94-1-1 am 12:6", 1394, 1, 1, 0, 6, 0, 0, true)]
        [InlineData("94-1-1 PM 3:6", 1394, 1, 1, 15, 6, 0, 0, true)]
        [InlineData("94-1-1 PM 10:6", 1394, 1, 1, 22, 6, 0, 0, true)]
        [InlineData("94-1-1 13:00", 1394, 1, 1, 13, 0, 0, 0, true)]
        [InlineData("1394-1-1 11:00 am", 1394, 1, 1, 11, 0, 0, 0, true)]
        [InlineData("94-12-29 00:00", 1394, 12, 29, 0, 0, 0, 0, true)]
        [InlineData("00/05/31 13:10:52", 1400, 5, 31, 13, 10, 52, 0, true)]
        [InlineData("99/10/30 11:12:33 PM", 1399, 10, 30, 23, 12, 33, 0, true)]
        [InlineData("94-1-1 13", 1394, 1, 1, 13, 0, 0, 0, false)]
        [InlineData("13945-1-1 11:00 am", 1394, 1, 1, 11, 0, 0, 0, false)]
        [InlineData("00/05/31 13:10:52:5", 1400, 5, 31, 13, 10, 52, 5, false)]
        public void TryParsePersianDateTime(string persianDateTimeStr, int year, int month, int day, int hour, int minute, int second, int milliseconds, bool expectedValid)
        {
            PersianDateTime persianDateTime;
            var isValid = PersianDateTime.TryParse(persianDateTimeStr, out persianDateTime);

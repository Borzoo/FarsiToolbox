...
namespace FarsiToolbox
{
    ...
    internal class NumberToWords
    {
        ...
        /// <summary>
        /// Converts passed number to written Farsi
        /// </summary>
        ...
        /// <summary>
        /// Converts passed number to ordinal written Farsi
        /// </summary>
        /// <param name="number"></param>
        /// <returns></returns>
        internal string ConvertToOrdinal(int number)
        {
            if (number == 1)
                return "اول";
